...
<body>
    <div class="heading">
        <a class="heading__logo" href="<?php echo SITE_URL ?>index.php?controller=trainee&action=indexTrainee"><i class="fas fa-home"></i></a>
        <h3 class="heading__title">Edit</h3>
    </div>

    <div class="grid wide">
        <div class="row">
            <form class="l-6 l-o-3" action="<?php echo SITE_URL ?>index.php?controller=trainee&action=update" method="post">
                ...
                <div class="input-group ">
                    ...
                    <input type="email" name="" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                </div>
                <div class="input-group ">
