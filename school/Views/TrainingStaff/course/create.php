...
<body>
    <div class="heading">
        ...
        <a class="heading__logo"href="<?php echo SITE_URL ?>index.php?controller=course&action=index" alt="logo"><i class="fas fa-home"></i></a>

        <h3 class="heading__title"></h3>
    </div>
    <div class="grid wide">
        <div class="row">
            <form class="l-6 l-o-3" method="post" action="<?php echo SITE_URL ?>index.php?controller=course&action=store">
